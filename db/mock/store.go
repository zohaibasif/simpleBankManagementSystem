...
// Source: github.com/zohaibAsif/simple_bank_management_system/db/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/zohaibAsif/simple_bank_management_system/db/sqlc"
	reflect "reflect"
)
...
func (m *MockStore) GetAccountForNoKeyUpdate(arg0 context.Context, arg1 int64) (sqlc.Account, error) {
	m.ctrl.T.Helper()
